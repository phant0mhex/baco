...
window.pageInit = () => {
  ...
  formIntervention.addEventListener('submit', async (e) => {
    ...
    if (error) notyf.error(error.message);
      ...
      notyf.success("Intervention ajoutée !");
